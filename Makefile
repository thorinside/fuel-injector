...
TEST_SOURCES = tests/test_main.cpp tests/test_example.cpp tests/test_data_structures.cpp tests/test_cv_clock.cpp tests/test_midi_clock.cpp tests/test_pattern_learning.cpp
